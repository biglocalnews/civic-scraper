...
class CivicClerkSite(base.Site):
    ...
    def _future_events(self):
        ...
        for page in self._paginate(callback_id):
            events = page.xpath("//table[@id='aspxroundpanelCurrent_pnlDetails_grdEventsCurrent_DXMainTable']/tr[@class='dxgvDataRow_CustomThemeModerno']")
            yield from events
    ...
    def _past_events(self):
        ...
        for page in self._paginate(callback_id):
            events = page.xpath("//table[@id='aspxroundpanelRecent2_ASPxPanel4_grdEventsRecent2_DXMainTable']/tr[@class='dxgvDataRow_CustomThemeModerno']")
            yield from events
    ...
    def _paginate(self, callback_id):
        ...
        while item_keys != previous_item_keys:
            ...
            item_keys = callback_state['keys']
            payload['__CALLBACKPARAM'] = 'c0:KV|61;' + demjson.encode(callback_state['keys']) + ';GB|20;12|PAGERONCLICK3|PBN;'
