...
from civic_scraper.base.asset import AssetCollection, Asset # For type hinting and inspection
from civic_scraper.platforms.granicus.site import GranicusSite # Tries to import from current dir
...
def run_granicus_test_scrape(url: str, panel_name: str | None = None, site_name_override: str | None = None):
    """
    ...
    if asset_collection and len(asset_collection) > 0:
        ...
        logger.error("Scrape method returned None, which is unexpected. Expected AssetCollection.")
