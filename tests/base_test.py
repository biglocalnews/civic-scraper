"""
This file is the base test file.
Change the "Scraper" import below to the platform-specific scraper you want to test.
For example, replace:
    from civic_scraper.platforms.scraper.site import Scraper
with:
    from civic_scraper.platforms.escribe.site import EscribeSite as Scraper
or another platform's site class as needed.
"""
